...
<header class="entry-header">
	...
	<span class="entry-meta"><?php elegantwriting_posted_on(); ?></span>
</header>
...
<?php else : ?>
	...
	<div class="blog-feed-thumbnail-entry-content">
		...
		<div class="blog-feed-meta">
			...
			<span class="post-date"><?php elegantwriting_posted_on(); ?></span>
			<!-- Sticky banner -->
			<?php if(is_sticky()) : ?>
			<div class="sticky-text"><?php esc_html_e( 'Featured', 'bright-writing' ); ?></div>
			<!-- Sticky banner end -->
		<?php endif; ?>
	</div>
	<div class="text-left">
		...
		<p class="readmore-btn-wrapper">
			<a href="<?php the_permalink(); ?>" class="readmore-btn">
				<?php esc_html_e( 'Continue reading', 'bright-writing' ); ?>
			</a>
		</p>
	</div>
</div>
