...
Bright Writing WordPress Theme, Copyright 2018 ThemeEverest
Bright Writing is distributed under the terms of the GNU GPL
All files included, for example Bright Writing.js is licensed under GPLv2 or later as well.

Bright Writing bundles the following third-party resources:
...
LINK: https://pxhere.com/en/photo/1452083
...
- Bright Writing theme has code forked from Blacklite WordPress Theme https://wordpress.org/themes/blacklite/ (Distributed on WordPress.org under GPLv2 or later) (C) zthemesteam
 - Bright Writing theme has code forked from Newspaperly https://wordpress.org/themes/newspaperly/ (Distributed on WordPress.org under GPLv2 or later) (C) Theme Everest
 - Bright Writing theme has code forked from Minimalistblogger https://wordpress.org/themes/minimalistblogger/ (Distributed on WordPress.org under GPLv2 or later) (C) Theme Everest
 - Bright Writing theme has code forked from Appage https://wordpress.org/themes/apppage/ (Distributed on WordPress.org under GPLv2 or later) (C) Vilhoprogramming
 - Bright Writing theme has code forked from Personalblogily https://wordpress.org/themes/personalblogily/ (Distributed on WordPress.org under GPLv2 or later) (C) Theme Everest
 - Bright Writing theme has code forked from Underscores http://underscores.me/, (C) 2012-2018 Automattic all is distributed under the terms of the GNU GPL and  Inc., [GPLv2 or later](https://www.gnu.org/licenses/gpl-2.0.html). 
* Bright Writing.js and all other custom JS scripts included is licensed under GPLv2 or later (http://www.gnu.org/licenses/gpl-2.0.html)
